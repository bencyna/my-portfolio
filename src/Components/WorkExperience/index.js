...
export default function WorkExperience() {
  ...
  <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24 border-b-2 border-white">
    <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
      <div className="space-y-5 sm:space-y-4">
        ...
        }} className="cursor-pointer text-gray-100 hover:text-gray-300 text-sm inline relative left-6">back to top ↑</div>
        <p className="text-xl  block">With over a year of software development experience and 6 months of learning how a business starts from the ground up, I
          ...
          <li>
            <div className="space-y-4">
              ...
              <div className="text-lg leading-6 font-medium space-y-1">
                ...
                <p className="text-yellow-100">Software Developer</p>
              </div>
              <div className="">
                <p className="">Building projects from the ground up, I worked with popular php tools such as Laravel and was the lead developer on a 7 month project. I worked with Java, C# and Javascript in my time at JAC as well</p>
              </div>

              <ul  className="flex space-x-5">
                <li>
                  <Link to='#' onClick={() => window.location.replace("https://au.linkedin.com/company/james-anthony-consulting")} className="text-gray-400 hover:">
                    <span className="sr-only">LinkedIn</span>
                    <svg className="w-7 h-7 hover:bg-gray-400" fill="white" viewBox="0 0 20 20" aria-hidden="true">
          ...
          <li>
            <div className="space-y-4">
              ...
              <div className="text-lg leading-6 font-medium space-y-1">
                ...
                <p className="text-yellow-100">Tutor</p>
              </div>
              <div className="">
                <p className="">
